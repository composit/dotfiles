function run_test_file(command_suffix)
    ...
    run_tests(vim.t.grb_test_file .. command_suffix)
end
...
if vim.fn.exists('*open_test_alternative') == 1 then
    return
end

function open_test_alternative()
